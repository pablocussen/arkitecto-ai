  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="w-full max-w-md p-8 space-y-6 glass-strong rounded-2xl">
        <h1 className="text-2xl font-bold text-center text-white">Login to Arkitecto AI</h1>
        ...
        <p className="text-sm text-center text-gray-500">
          ...
          <button onClick={onSwitchToSignUp} className="font-medium text-neon-cyan hover:underline">
            Sign up
          </button>
        </p>
      </div>
